    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Warteg Wareg</span>
            </a>
...
{{--@endforeach--}}
{{--<br>--}}
{{--<div class="bg-red-200">hahsdhasda</div>--}}

<section class="m-2 p-10 bg-blue-950 rounded-2xl">
    {{--    HERO   --}}
    <div class=" flex justify-center flex-col">
        ...
        <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            Restoran Kami Menyajikan Makanan yeng enak Dan halal. yang telah di setujui oleh MUI
        </p>
...
<section class="m-2 p-10 bg-blue-950 rounded-2xl">
    <div class="py-5 bg-blue-400 my-2 rounded-2xl">
        <p class="text-3xl text-gray-900 dark:text-white text-center">
            Daftar Menu
        </p>
    </div>

    {{--list Makanan--}}
    <div class=" flex flex-auto gap-2 my-10">
        @if(isset($makanan))
            @foreach($makanan as $value)
                {{--                <div class="list" style="border: 1px solid black; margin-top: 5px; padding: 5px; border-radius: 1rem; ">--}}
                {{--                    <p> Nama : {{$value['nama']}}</p>--}}
                {{--                    <p> Harga : Rp.{{number_format($value['harga'])}}</p>--}}
                {{-- <p> Gambar : {{$value['gambar']}}</p>--}}
                {{--                    <img src="{{$value['gambar']}}" alt="{{$value['nama']}}" style=" width: 5rem; height: 5rem; border: 2px solid #ffffff; border-radius: 1rem"/>--}}
                {{--                    <p> Stok : {{$value['stok']}}</p>--}}
                {{--                </div>--}}

                <div
                    class="mt-2 flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-blue-900 md:max-w-xl md:flex-row">
                    ...
                    <div class="">
                        ...
                        <div class="px-6 pt-4 pb-2">
                            <span
                                class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Tambah</span>
                            <span
                                class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Hapus</span>
                        </div>
                    </div>
                </div>
            @endforeach
